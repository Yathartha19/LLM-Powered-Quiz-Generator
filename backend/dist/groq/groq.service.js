...
let GroqService = class GroqService {
    ...
    constructor(configService) {
        ...
        if (!apiKey) {
            throw new common_1.InternalServerErrorException('GROQ_API_KEY is not defined in environment variables');
        }
    ...
    async getChatCompletion(prompt) {
        try {
            ...
            throw new common_1.InternalServerErrorException('Failed to fetch from Groq API');
        }
    }
};
